...
Use only the runner below. Run these commands from the project root:
...
- To convert an existing report without re-running tests (run from the project root): ```.\runner.ps1 -cr```
